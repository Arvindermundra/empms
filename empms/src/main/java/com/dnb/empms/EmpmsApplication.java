...
public class EmpmsApplication {
	...
	public static void main(String[] args) {
		...
		Employee employee = new Employee("AM","Operations", 98000);
		employeeRepository.save(employee);
		//System.out.println(employeeRepository.findBySalaryBetween(0, 90000));
//		employeeRepository.findByDept("Tech");
//		employeeRepository.findBySalaryGreaterThan(2000);
